...
**Respuesta**: El gráfico es un boxplot y las lineas representan las medianas de los grupos representados por las cajas.
...
**Respuesta**: Adiciona una columna a df_seeds. Esta nueva columna se llama is_kama y tiena valor TRUE si la flor es del tipo Kama, FALSE en caso contrario.
...
**Respuesta**: Dividiendo el dataset en grupos train y test podemos estimar si nuestro modelo funcionará bien con datos nuevos. Usamos en grupo train para entrenar nuestro modelo y luego el grupo test para evaluarlo, esto nos dice si el modelo funcionará bien con datos nuevos ya que no hemos usado los datos del test para entrenar el modelo.
...
**Respuesta**: Modelo linear generalizado (GLM)
